...
public class ABBReservaciones {
     ...
     */
    public void insertNodo(NodoReservacion raiz, Client cliente){
     ...
     * @return <code>Client</code> que tiene el CI ingresado
     *         <code>null</code> si el cliente no existe (No hizo reserva).
     */
    public Client buscarReservacion(NodoReservacion root, int cedula) {
        if (!this.isEmpty()) {
            if (root == null) {
                return null;
            } else {
